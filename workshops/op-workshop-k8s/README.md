...
> [!IMPORTANT]
> This is a k8s based workshop, if you are looking for something VM based with a load balancer instead, please [see this lab](https://github.com/DataDog/logs-psa/tree/main/workshops/op-workshop-vms).
